    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-4 px-5 py-4 my-5 text-center position-absolute bck" >
                ...
                <form:form action="/finanzas/informe/diario/${pyme.id}" method="post" modelAttribute="formulario_diario">
                    <div class="flex form">
                    ...
                    <div class="flex form">
                        <form:label class="form-label" path="ingresoTotalDiario"><strong>Ingreso Diario:</strong></form:label>
                    ...
                    <button class="ingresarButton" type="submit">Ingresar Datos</button>
                </form:form>

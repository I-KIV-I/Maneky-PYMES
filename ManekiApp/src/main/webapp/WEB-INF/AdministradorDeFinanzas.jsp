			...
			<div class="navigation">
				<ul class="mainUl">
					<li class="first">
						<a href="/herramientas" class="seleccion">
							<span class="icon"><img src="/img/LogoManeki.png" alt="logo"
									class="logo"></span>
					...
					<li>
						<a href="/perfil" class="seleccion">
							<span class="icon"><img src="/img/profile.svg"
									alt="icono profile"></span>
					...
					<li>
						<div class="seleccion finanzas">
							<div>
								<div class="titleBox">
									<span class="icon"><img src="/img/finances.svg" alt="icono"
								...
								<div class="pymeBox">
									<ul class="secondUl">
										<c:foreach var="pyme" items="${listaPymes}">
											<li><a href="/finanzas/${pyme.id}"
													class="pyme">${pyme.nombre}</a></li>
										</c:foreach>
									</ul>
								</div>
							</div>
				...
				<div class="main">
					...
					<div class="cardcss">
						...
						<div class="cardName">Ingesa Informe Diario </div>
						<div class="iconBx">
							<img src="/img/piggy.svg">
						</div>
					</div>
						...
						<table>
							<tr>
								...
								<td>
									<h4>
										Cuidado
										<span>Parece que tus ahorros son bajos, recuerda no gastar
											demasiado</span>
									</h4>
								</td>
							</tr>
							<tr>
								...
								<td>
									<h4>
										Ahorra
										<span>Manten siempre un colchon de dinero ahorrado ante cualquier
											cosa</span>
									</h4>
								</td>
							</tr>
